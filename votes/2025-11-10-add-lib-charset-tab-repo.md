# 申请创建 lib-charset-tab 项目

## 项目基本信息

项目名称： ob-charset-tab

项目目的： ob的编译方便以及增加可读性和自研率，采取把tab文件分离单独成库的方法改善这个问题。

项目责任人(github id):

- Maintainer: qingzhu521
- Maintainer: LesinLi
...
参考 [创建 ob-charset-tab 项目投票结果](https://github.com/oceanbase/community/pull/51)。
