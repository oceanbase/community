# 申请创建 dify-plugin-powermem 项目

## 项目基本信息

项目名称：dify-plugin-powermem

项目目的：powermem 的 Dify plugin
...
## 投票截止时间
如果不满足投票条件，此投票将在 2025 年 12 月 16 日截止。

> 满足投票条件是说投票已经成功，比如已经有不少于 2/3 的 TOC 投票，或者投票失败，比如有一半的 TOC 反对。


## 投票结果
参考 [创建 dify-plugin-powermem 项目投票结果](https://github.com/oceanbase/community/pull/60)。
