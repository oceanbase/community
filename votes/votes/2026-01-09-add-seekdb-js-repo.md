...
项目目的：面向 js 开发者，为AI开发者提供易用的向量数据库客户端工具，数据库支持 OceanBase、 服务版 SeekDB 和 嵌入式 SeekDB。

项目责任人(github id)：

- Maintainer: raindrop93
...
如果不满足投票条件，此投票将在 2026 年 01 月 20 日截止。

> 满足投票条件是说投票已经成功，比如已经有不少于 2/3 的 TOC 投票，或者投票失败，比如有一半的 TOC 反对。

## 投票结果

参考 [创建 seekdb-js 项目投票结果](https://github.com/oceanbase/community/pull/66)。
