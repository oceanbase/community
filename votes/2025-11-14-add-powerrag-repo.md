...
项目目的：PowerRAG 是一款 RAG 开发平台，集成了 OceanBase 特有的多模检索，可以构建更易用、更准确的 RAG 系统。

项目责任人(github id)：

- Maintainer: caifeizhi
- Maintainer: whhe
- Committer: CHLK
- Committer: Zhangg7723
...
## 投票截止时间
如果不满足投票条件，此投票将在 2025 年 11 月 21 日截止。

> 满足投票条件是说投票已经成功，比如已经有不少于 2/3 的 TOC 投票，或者投票失败，比如有一半的 TOC 反对。


## 投票结果
参考 [创建 powerrag 仓库投票结果](https://github.com/oceanbase/community/pull/56)。
