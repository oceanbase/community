# 申请创建 Spark Connector 项目

## 项目基本信息

项目名称：spark-connector-oceanbase

项目目的：提供用于读写 OceanBase 数据的 Spark 插件，类似 https://github.com/oceanbase/flink-connector-oceanbase 。 
...
参考 [创建 Spark Connector 项目投票结果](https://github.com/oceanbase/community/pull/20)。
